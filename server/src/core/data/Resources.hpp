...
class Resources {
    ...
    std::string get_name(ResourceType type) const
    {
        return get_name(static_cast<int>(type));
    }
    ...
    {
        return (*this)[static_cast<size_t>(type)];
    }
    ...
    {
        switch (type) {
            case ResourceType::FOOD:        return 0.5f;
            case ResourceType::LINEMATE:    return 0.3f;
            case ResourceType::DERAUMERE:   return 0.15f;
            case ResourceType::SIBUR:       return 0.1f;
            case ResourceType::MENDIANE:    return 0.1f;
            case ResourceType::PHIRAS:      return 0.08f;
            case ResourceType::THYSTAME:    return 0.05f;
            default: throw std::out_of_range("Invalid resource type");
        }
    }
