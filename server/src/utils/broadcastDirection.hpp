...
inline int broadcastDirection(int srcX, int srcY, int dstX, int dstY,
                               int mapW, int mapH, Orientation dstFacing)
{
    ...
    int rx, ry;
    switch (dstFacing) {
        case Orientation::N: rx =  dx; ry = -dy; break;
        case Orientation::E: rx =  dy; ry =  dx; break;
        case Orientation::S: rx = -dx; ry =  dy; break;
        case Orientation::W: rx = -dy; ry = -dx; break;
