...
namespace clap {
    ...
    class UnknownArgument : public ClapException {
        public:
        UnknownArgument(const std::string& arg) : ClapException("Unknown argument: " + arg) {}
    };

    class MissingValue : public ClapException {
        public:
        MissingValue(const std::string& arg) : ClapException("Missing value for argument: " + arg)
        {
        }
    };
    ...
    class ConfigError : public ClapException {
        public:
        ConfigError(const std::string& msg) : ClapException("Configuration error: " + msg) {}
    };
    ...
    class ParseError : public ClapException {
        public:
        ParseError(const std::string& msg) : ClapException("Parse error: " + msg) {}
    };
}  // namespace clap
