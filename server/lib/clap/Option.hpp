...
namespace clap {
    ...
    class Option : public IArgument {
        ...
        // TODO: better parsing
        void parse(std::string_view value) override { _value = clap::ParseValue<T>::parse(value); }

        std::string_view type_name() const override { return clap::TypeName<T>::value; }
        ...
        const T& get() const
        {
            ...
            if (_default_value.has_value()) return _default_value.value();
