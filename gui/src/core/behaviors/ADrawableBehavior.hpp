...
/**
 * @brief Base class for behaviors that produce visual drawables: sphere particles and line segments.
 * IBehavior stays a pure interface; ADrawableBehavior adds particle and line storage.
 */
